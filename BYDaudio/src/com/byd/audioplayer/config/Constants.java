package com.byd.audioplayer.config;
...
public class Constants {
    ...
    public static final String MUSIC_URL = "com.byd.audioplayer.URL";

    public static final String MUSIC_DURATION = "com.byd.audioplayer.Duration";

    public static final String MUSIC_CURRENT = "com.byd.audioplayer.Current";

    public static final String MUSIC_SEEK_TO = "com.byd.audioplayer.SeekTo";

    public static final String AUDIO_FX_ID = "com.byd.audioplayer.AudioFxId";

    public static final String IS_AUX_CONNECTED = "com.byd.audioplayer.IsAuxConnected";
