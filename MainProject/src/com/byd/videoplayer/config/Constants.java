package com.byd.videoplayer.config;
...
public class Constants {
    ...
    public static final String MUSIC_SONG_POSITION = "com.byd.videoplayer.SongPosition";

    public static final String PLAYER_MSG = "com.byd.videoplayer.MSG";

    public static final String MUSIC_URL = "com.byd.videoplayer.URL";

    public static final String MUSIC_DURATION = "com.byd.videoplayer.Duration";

    public static final String MUSIC_CURRENT = "com.byd.videoplayer.Current";

    public static final String MUSIC_SEEK_TO = "com.byd.videoplayer.SeekTo";

    public static final String AUDIO_FX_ID = "com.byd.videoplayer.AudioFxId";

    public static final String IS_AUX_CONNECTED = "com.byd.videoplayer.IsAuxConnected";
