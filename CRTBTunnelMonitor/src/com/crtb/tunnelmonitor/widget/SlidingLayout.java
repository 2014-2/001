...
public class SlidingLayout extends RelativeLayout implements OnTouchListener {
	 ...
	 * 初次加载完成
	 */
	private  LayouFirstLoadedEvent layoutLoadEvent  = null;
	/**
	...
	public void setLayoutLoadedEvent(LayouFirstLoadedEvent layoutLoadEvent){
		this.layoutLoadEvent = layoutLoadEvent;
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed) {
			...
			if(isFirst && layoutLoadEvent != null){
				isFirst = false;
				layoutLoadEvent.callback();
			}
		}
	}
	 ...
	 */
	private void setBindViewFocus(boolean state) {
		if (mBindView != null) {
			mBindView.setPressed(state);
			mBindView.setFocusable(state);
			mBindView.setFocusableInTouchMode(state);
		}
	}

	public interface LayouFirstLoadedEvent{
