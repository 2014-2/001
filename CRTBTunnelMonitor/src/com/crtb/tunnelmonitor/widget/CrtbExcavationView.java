...
public class CrtbExcavationView extends View {
	...
	public void setPointNumber(int number){
		...
		if(number < 0 || number > 8 || number % 2 != 0){
			return ;
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		for(int i = 0 ; i < mPair / 2 ; i++){
			...
			drawPointText(canvas, String.valueOf(++index), nlx, nly, 0);
			...
			drawPointText(canvas,String.valueOf(++index),elx,ely,1);
		...
		for(int i = 0 ; i < mPair / 2 ; i++){
			...
			drawPointText(canvas, String.valueOf(++index), erx, ery, 0);
			...
			drawPointText(canvas, String.valueOf(++index), nrx, nry, 1);
	...
	private void drawPointText(Canvas canvas ,String text,int x, int y, int dir){
