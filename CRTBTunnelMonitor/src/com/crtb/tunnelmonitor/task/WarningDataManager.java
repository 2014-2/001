...
//	}
    ...
    private void uploadWarningData(UploadWarningData warningData, final DataCounter warningUploadCounter) {
    	...
    	parameter.setTransformSpeed(sulvalert != null ? (float)sulvalert.getUValue() - sulvalert.getCorrection(): 0.001f);
...
//        }
    	...
    	parameter.setWarningPointValue((float) (leijiAlert != null ? leijiAlert.getUValue() - leijiAlert.getCorrection() : 0.001f));
